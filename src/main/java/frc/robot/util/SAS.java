...
public class SAS {
    ...
    public SAS(){
        ...
        shotTable.put(50.0, new ShooterState(64, 2100));
        shotTable.put(80.0, new ShooterState(47, 2300));
        shotTable.put(110.0, new ShooterState(42, 2400));
        shotTable.put(140.0, new ShooterState(38, 2500));
